...
public class ViewTableTest {
    ...
    public void testSelecAll() {
        String sql = "select * from depts_view";
    ...
    @Test
    public void testSelecWhere() {
        String sql = "select * from depts_view where empno=100";
    ...
    private String executeSql(String sql) {
        String path = ViewTableTest.class.getResource("/model-with-view.json").toString();
