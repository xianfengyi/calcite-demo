...
public interface SqlParserImplConstants {
  ...
  int ZONE = 684;
  /** RegularExpression Id. */
  int UNSIGNED_INTEGER_LITERAL = 685;
  /** RegularExpression Id. */
  int APPROX_NUMERIC_LITERAL = 686;
  /** RegularExpression Id. */
  int DECIMAL_NUMERIC_LITERAL = 687;
  /** RegularExpression Id. */
  int EXPONENT = 688;
  /** RegularExpression Id. */
  int HEXDIGIT = 689;
  ...
  int WHITESPACE = 690;
  /** RegularExpression Id. */
  int BINARY_STRING_LITERAL = 691;
  /** RegularExpression Id. */
  int QUOTED_STRING = 692;
  /** RegularExpression Id. */
  int PREFIXED_STRING_LITERAL = 693;
  /** RegularExpression Id. */
  int UNICODE_STRING_LITERAL = 694;
  /** RegularExpression Id. */
  int CHARSETNAME = 695;
  /** RegularExpression Id. */
  int BIG_QUERY_DOUBLE_QUOTED_STRING = 696;
  /** RegularExpression Id. */
  int BIG_QUERY_QUOTED_STRING = 697;
  /** RegularExpression Id. */
  int UNICODE_QUOTED_ESCAPE_CHAR = 698;
  /** RegularExpression Id. */
  int LPAREN = 699;
  /** RegularExpression Id. */
  int RPAREN = 700;
  ...
  int SLASH = 724;
  /** RegularExpression Id. */
  int PERCENT_REMAINDER = 725;
  /** RegularExpression Id. */
  int CONCAT = 726;
  /** RegularExpression Id. */
  int NAMED_ARGUMENT_ASSIGNMENT = 727;
  /** RegularExpression Id. */
  int DOUBLE_PERIOD = 728;
  /** RegularExpression Id. */
  int QUOTE = 729;
  /** RegularExpression Id. */
  int DOUBLE_QUOTE = 730;
  /** RegularExpression Id. */
  int VERTICAL_BAR = 731;
  /** RegularExpression Id. */
  int CARET = 732;
  /** RegularExpression Id. */
  int DOLLAR = 733;
  ...
  int COMMENT_END = 740;
  /** RegularExpression Id. */
  int SINGLE_LINE_COMMENT = 743;
  /** RegularExpression Id. */
  int FORMAL_COMMENT = 744;
  /** RegularExpression Id. */
  int MULTI_LINE_COMMENT = 745;
  /** RegularExpression Id. */
  int BRACKET_QUOTED_IDENTIFIER = 747;
  /** RegularExpression Id. */
  int QUOTED_IDENTIFIER = 748;
  /** RegularExpression Id. */
  int BACK_QUOTED_IDENTIFIER = 749;
  /** RegularExpression Id. */
  int HYPHENATED_IDENTIFIER = 750;
  /** RegularExpression Id. */
  int IDENTIFIER = 751;
  /** RegularExpression Id. */
  int COLLATION_ID = 752;
  /** RegularExpression Id. */
  int UNICODE_QUOTED_IDENTIFIER = 753;
  /** RegularExpression Id. */
  int LETTER = 754;
  /** RegularExpression Id. */
  int DIGIT = 755;
